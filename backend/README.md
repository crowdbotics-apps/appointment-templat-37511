...
## Project Structure
    ...
    ├── appointment_templat_37511  # Django project configurations
...
1. Clone this repo and `cd appointment_templat_37511`
...
2. Clone this repo and `cd appointment_templat_37511`
