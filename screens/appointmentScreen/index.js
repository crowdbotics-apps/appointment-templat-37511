...
const Appointment = ({
  ...
  const toggleSwitch2 = () => setIsEnabled2(previousState => !previousState); // @ts-ignore


  const meetingTitle = ['Voice Call', 'Messaging', 'Video Call'];
  const meetingIcons = [require("./assets/phone.png"), require("./assets/message.png"), require("./assets/video.png")];
  useEffect(() => {
    dispatch(getMeetingInfo()).then(unwrapResult).then(res => {
      setMeetingInfo(res);
    }).catch(error => {
  ...
  return <View style={styles.container}>
            <ScrollView>
                <View style={styles.header}>
                    <Pressable>
                        <Image // @ts-ignore
          source={require("./assets/back.png")} style={styles.message} />
                    </Pressable>
          ...
          "./assets/next.png")} style={styles.prev} />
                    ...
                    <View style={[styles.inner, styles.viMSbKVz]}>
                        ...
                        <View style={[styles.dateContainer, styles.glAOqOih]}>
                ...
                <View style={styles.tabContainer}>
                    ...
                    <View style={styles.tabView}>
                        ...
                        <View style={styles.msMmcNqf}>
                            <View style={[styles.tabView, styles.MneayhKG]}>
                                <Image source={require( // @ts-ignore
              ...
              "./assets/check.png")} style={styles.prev1} />
                ...
                <View style={[styles.midSection]}>
                    <View style={[styles.inner, styles.ocFTHaOm]}>
                    ...
                    {meetingInfo.map((fee, index) => <View style={styles.walletCard} key={index}>
                ...
                <View style={styles.cardInfo}>
                    ...
                    <View style={styles.feeContainer}>
                        <View>
                            <Text style={[styles.mr10, styles.ByoHewIM]}>Age</Text>
                            <View style={styles.feeSection}>
                                <TextInput placeholder="Enter" placeholderTextColor={"#000"} />
                            </View>
                        </View>
                        <View>
                            <Text style={[styles.mr10, styles.JlhBTBzf]}>Gender</Text>
                            <View style={styles.feeSection}>
                                <TextInput placeholder="Enter" placeholderTextColor={"#000"} />
                            </View>
                        </View>
                    ...
                    <Text style={[styles.subHeading, styles.mpswBaWj]}>Request access</Text>
      ...
      require("./assets/search.png"), // @ts-ignore
...
const Input = props => {
  return <View style={styles.container}>
            <TextInput style={inputStyles.input} placeholder={props.placeholder} value={props.value} onChangeText={num => props.setValue(num)} placeholderTextColor='#000' multiline={props.multiline} numberOfLines={props.multiline ? 10 : null} editable={props.editable !== false} // @ts-ignore
