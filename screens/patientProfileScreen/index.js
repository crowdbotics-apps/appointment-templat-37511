  ...
  return <View style={styles.container}>
            <ScrollView>
                ...
                <View style={styles.cardInfo}>
                    <View style={[styles.headingContainer, styles.mlmfvKtI]}>
                    ...
                    <View style={styles.feeContainer}>
                        <View>
                            <Text style={[styles.mr10, styles.rrucGcvN]}>Age</Text>
                            <View style={styles.feeSection}>
                                <TextInput placeholder="Enter" placeholderTextColor={"#000"} />
                            </View>
                        </View>
                        <View>
                            <Text style={[styles.mr10, styles.BHRxcemm]}>Gender</Text>
                            <View style={styles.feeSection}>
                                <TextInput placeholder="Enter" placeholderTextColor={"#000"} />
                            </View>
                        </View>
                    ...
                    <Text style={[styles.subHeading, styles.UkKAZeUu]}>System request access</Text>
