...
const MyCalender = ({
  ...
  return <View style={styles.container}>
        ...
        source={require("./assets/back.png")} style={styles.message} />
                ...
                <Pressable>
                    <Image // @ts-ignore
        source={require("./assets/bell.png")} style={styles.bell} />
                </Pressable>
            </View>
        ...
        "./assets/next.png")} style={styles.prev} />
                ...
                <View style={[styles.inner, styles.HVMnpleN]}>
                    ...
                    <View style={[styles.dateContainer, styles.mSByRton]}>
        ...
        "./assets/progress.png")} style={styles.progress} />
                    <View style={[styles.leftSection, styles.qgtIJdwe]}>
              ...
              "./assets/check.png")} style={styles.check} />
                        ...
                        <View style={[styles.docContainer, styles.AORMOfaQ]}>
              ...
              "./assets/check.png")} style={styles.check} />
                        ...
                        <View style={[styles.docContainer, styles.oltnIwsO]}>
              ...
              "./assets/check.png")} style={styles.check} />
                        ...
                        <View style={[styles.docContainer, styles.NqWncDvT]}>
                            <Text style={[styles.titleText, styles.fFtTtCjS]}>Free slot</Text>
                            <Text style={[styles.descr, styles.QTNbUKao]}>Available time </Text>
                        </View>
                        <View style={[styles.docContainer, styles.eLIVzwpi]}>
                            <Text style={[styles.titleText, styles.DtUZWJKq]}>Free slot</Text>
                            <Text style={[styles.descr, styles.pFvDUrAo]}>Available time </Text>
                        </View>
                        <View style={[styles.docContainer, styles.aXORhAqE]}>
                            <Text style={[styles.titleText, styles.AfwBdSiQ]}>Free slot</Text>
                            <Text style={[styles.descr, styles.ssemoskx]}>Available time </Text>
                        </View>
                    </View>
                </View>
            </ScrollView>
