          ...
          "./assets/close.png")} style={styles.image} />
                ...
                <View style={[styles.mainContainer]}>
                    ...
                    <View style={styles.inner}>
                        <Image source={require( // @ts-ignore
          "./assets/phone.png")} style={[styles.check, styles.YvOrRXSS]} />
                        <Image source={require( // @ts-ignore
          "./assets/message.png")} style={styles.check} />
                    </View>
                </View>
                <Text style={[styles.title, styles.QIJbEBPs]}>Date/time</Text>
                <View style={styles.topWrapper}>
                    ...
                    <View style={[styles.inner, styles.PRLHdVnt]}>
                        ...
                        <View style={[styles.dateContainer, styles.bCSbhhBQ]}>
                ...
                <View style={[styles.inner, styles.EDxkDhdD]}>
