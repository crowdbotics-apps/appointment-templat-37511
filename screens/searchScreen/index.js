...
const Search = ({
  ...
  return <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <View style={styles.searchContainer}>
                    ...
                    <View style={styles.inputText}>
                        <View style={styles.QxFTRkPI}>
                            <TextInput // value={searchText}
            onChangeText={text => handleSearchStore(text)} placeholder='Enter' placeholderTextColor={"#000"} style={styles.dZSSQGug} />
                        </View>
        ...
        item,
        index
      }) => <Category category={item} index={index} />} numColumns={3} keyExtractor={item => item.id.toString()} columnWrapperStyle={styles.columnWrapper} />
            </View>
            <View style={[styles.headingContainer, styles.topsec]}>
                <Text style={styles.title}>{service_providers.length} Doctors Found</Text>
                <Text></Text>
            </View>
            <ScrollView style={styles.oSEaDcZC}>
                {providersList.map((item, index) => <Pressable style={styles.walletCard} key={index} onPress={() => navigation.navigate('doctorProfileScreen', {
        item
      })}>
