  ...
  return <View style={styles.container}>
            ...
            './assets/message.png')} style={styles.phone} />
                ...
                <View style={styles.amountContainer}>
                    <View style={[styles.scheduledContainer, styles.MMLTkwfc]}>
                    ...
                    <View style={[styles.scheduledContainer, styles.border]}>
                        ...
                        <View style={[styles.alignContent]}>
                            ...
                            <Text style={[styles.amount, styles.SDoldGst]}>$10</Text>
                        </View>
                    </View>
          ...
          "./assets/next.png")} style={styles.nextImg} />
                ...
                <View style={[styles.headingContainer, styles.mrjRpyNM]}>
                ...
                <View style={styles.cardInfo}>
                    <View style={[styles.headingContainer, styles.yaBlMlcA]}>
...
const Button = props => {
  return <TouchableOpacity onPress={props.onPress} // @ts-ignore
