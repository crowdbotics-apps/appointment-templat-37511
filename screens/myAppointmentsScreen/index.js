...
import { Text, StyleSheet, View, ScrollView, Image, Pressable, ImageBackground } from "react-native";
                    ...
                    <ImageBackground source={require('./assets/background.png')} resizeMode="cover" style={styles.backgroundImage}>
                        <View style={styles.innerWrapper}>
                            ...
                            <View style={styles.topWrapper}>
                                ...
                                <View style={[styles.inner, styles.TcvahMJw]}>
                                    ...
                                    <View style={[styles.dateContainer, styles.qACtFwhI]}>
